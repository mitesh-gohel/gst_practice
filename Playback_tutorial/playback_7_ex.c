//Extercise of playback tutorial-7 : Changing video sink of playbin
#include <gst/gst.h>
...
main (int argc, char *argv[])
{
  ...
  filter = gst_element_factory_make ("vertigotv", "my-filter");
  convert = gst_element_factory_make ("videoconvert", "convert");
  sink = gst_element_factory_make ("autovideosink", "audio_sink");
